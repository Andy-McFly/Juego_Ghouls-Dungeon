...
public class JuegoFase1
{
	...
	Image imagenFondo = new ImageIcon(getClass().getResource("img/bosque.png")).getImage();
	...
	Image imgEnemigo1 = new ImageIcon(getClass().getResource("img/loboBlanco.png")).getImage();
	Image imgEnemigo1Ataca = new ImageIcon(getClass().getResource("img/LoboBlancoAtaca.png")).getImage();
	Image imgEnemigo1Herido = new ImageIcon(getClass().getResource("img/loboBlancoHerido.png")).getImage();
	Image imgEnemigo1Actual = imgEnemigo1;
	
	Image imgEnemigo2 = new ImageIcon(getClass().getResource("img/lobo.png")).getImage();
	Image imgEnemigo2Ataca = new ImageIcon(getClass().getResource("img/LoboAtaca.png")).getImage();
	Image imgEnemigo2Herido = new ImageIcon(getClass().getResource("img/loboHerido.png")).getImage();
	...
	public JuegoFase1(Juego juegoEnv, Jugador jugador, Armadura armadura, Arma arma) 
	{
		...
		panelFondo = new JPanel()
        {
            public void paintComponent(Graphics g)
            {
                ...
                g.drawString("Fase 1: Bosque", 395, 30);
                ...
                g.drawImage(imgEnemigo1Actual, 430, 330, 31+40, 24+40, null);
                g.drawImage(imgEnemigo2Actual, 550, 380, 28+40, 31+40, null);
                g.drawImage(imgVida, 195, 310, 20+20, 20+20, null);
                g.drawImage(imgVida, 445, 280, 20+20, 20+20, null);
                g.drawImage(imgVida, 565, 330, 20+20, 20+20, null);
                g.setColor(Color.white);
                g.setFont(new Font("Calibri", Font.BOLD, 18));
                g.drawString(jugador.getVitalidad()+"", 207, 336);
                g.drawString(vidaEnemigo1+"", 457, 306);
                g.drawString(vidaEnemigo2+"", 577, 356);
		...
		panelFondo.addMouseMotionListener(new MouseMotionAdapter() {
		    ...
		    public void mouseMoved(MouseEvent e) 
		    {
		        ...
		        else if (mouseX >= 430 && mouseX <= 430 + 71 && mouseY >= 330 && mouseY <= 330 + 64 && vidaEnemigo1 > 0 && vidaJugador > 0) 
		        {
		        	panelFondo.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		            lblInfo.setText("Atacar a Lobo Blanco");
		        } 
		        else if (mouseX >= 550 && mouseX <= 550 + 68 && mouseY >= 380 && mouseY <= 380 + 71 && vidaEnemigo2 > 0 && vidaJugador > 0) 
			    {
		        	panelFondo.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			        lblInfo.setText("Atacar a Lobo");
			    }
		        else 
		        {
		...
		panelFondo.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) 
            {
            	...
            	//Click en HUD al finalizar la partida.
            	...
            	if (e.getX() >= 430 && e.getX() <= 430 + 71 && e.getY() >= 330 && e.getY() <= 330 + 64 && vidaEnemigo1 > 0 && vidaJugador > 0) 
        		{
            		if(turno) 
            		{
            			juego.clickFase1(e.getX(), e.getY());
            	...
            	else if (e.getX() >= 550 && e.getX() <= 550 + 68 && e.getY() >= 380 && e.getY() <= 380 + 71 && vidaEnemigo2 > 0 && vidaJugador > 0) 
        		{
            		if(turno) 
            		{
						juego.clickFase1(e.getX(), e.getY());
	...
	public void actualizarFase1(Jugador jugador, Enemigo enemigo1, Enemigo enemigo2, Arma arma, Armadura armadura, 
