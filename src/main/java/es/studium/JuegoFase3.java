...
public class JuegoFase3
{
	...
	Image imagenFondo = new ImageIcon(getClass().getResource("img/castillo.png")).getImage();
	...
	Image imgEnemigo1 = new ImageIcon(getClass().getResource("img/zombi.png")).getImage();
	Image imgEnemigo1Ataca = new ImageIcon(getClass().getResource("img/zombiAtaque.png")).getImage();
	Image imgEnemigo1Herido = new ImageIcon(getClass().getResource("img/zombiHerido.png")).getImage();
	Image imgEnemigo1Actual = imgEnemigo1;
	
	Image imgEnemigo2 = new ImageIcon(getClass().getResource("img/zombiB.png")).getImage();
	Image imgEnemigo2Ataca = new ImageIcon(getClass().getResource("img/zombiBAtaque.png")).getImage();
	Image imgEnemigo2Herido = new ImageIcon(getClass().getResource("img/zombiBHerido.png")).getImage();
	...
	public JuegoFase3(Juego juegoEnv, Jugador jugador, Armadura armadura, Arma arma) 
	{
		...
		panelFondo = new JPanel()
        {
            public void paintComponent(Graphics g)
            {
                ...
                g.drawString("Fase 3: Castillo", 395, 30);
                ...
                g.drawImage(imgEnemigo1Actual, 446, 340, 40, 60, null);
                g.drawImage(imgEnemigo2Actual, 566, 380, 46, 67, null);
                g.drawImage(imgVida, 195, 310, 20+20, 20+20, null);
                g.drawImage(imgVida, 445, 340-60, 20+20, 20+20, null);
                g.drawImage(imgVida, 565, 380-60, 20+20, 20+20, null);
                g.setColor(Color.white);
                g.setFont(new Font("Calibri", Font.BOLD, 18));
                g.drawString(jugador.getVitalidad()+"", 207, 336);
                g.drawString(vidaEnemigo1+"", 457, 366-60);
                g.drawString(vidaEnemigo2+"", 577, 406-60);
        ...
        lblInfo.setBounds(550, 505, 170, 30);
		...
		panelFondo.addMouseMotionListener(new MouseMotionAdapter() {
		    ...
		    public void mouseMoved(MouseEvent e) 
		    {
		        ...
		        else if (mouseX >= 446 && mouseX <= 446 + 40 && mouseY >= 340 && mouseY <= 340 + 60 && vidaEnemigo1 > 0 && vidaJugador > 0) 
		        {
		        	panelFondo.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		            lblInfo.setText("Atacar a Zombi");
		        } 
		        else if (mouseX >= 566 && mouseX <= 566 + 46 && mouseY >= 380 && mouseY <= 380 + 67 && vidaEnemigo2 > 0 && vidaJugador > 0) 
			    {
		        	panelFondo.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			        lblInfo.setText("Atacar a Zombi con armadura");
			    }
		        else 
		        {
		...
		panelFondo.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) 
            {
            	...
            	if (mouseX >= 446 && mouseX <= 446 + 40 && mouseY >= 340 && mouseY <= 340 + 60 && vidaEnemigo1 > 0 && vidaJugador > 0) 
        		{
            		if(turno) 
            		{
            			juego.clickFase3(e.getX(), e.getY());
	...
	public void actualizarFase3(Jugador jugador, Enemigo enemigo1, Enemigo enemigo2, Arma arma, Armadura armadura, 
